...
const RemoveObject = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6] to-[#8E37EB] hover:from-[#3666D8] hover:to-[#7B2FCC] text-white px-4 py-2
        mt-6 text-sm rounded-lg cursor-pointer transition-all duration-300 hover:shadow-lg active:scale-[0.98]'>
            {loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin'></span> : <Scissors className='w-4 h-4'/>}
            Remove Object
        </button>
