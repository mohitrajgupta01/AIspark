...
const BlogTitles = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <br />
        <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#C341F6] to-[#8E37EB] hover:from-[#1959E6] hover:to-[#4C9FFF] text-white px-4 py-2
                ...
                !content ? (
                    <div className='flex-1 flex justify-center items-center'>
                     ...
                     <div className='mt-3 flex-1 overflow-y-auto max-h-96 '>
                                        ...
                                        prose-blockquote:border-l-4 prose-blockquote:border-purple-200 
                                        ...
                                        [&_ul>li::marker]:content-["●"] [&_ul>li::marker]:text-purple-500 [&_ul>li::marker]:text-lg
                                        [&_ol>li]:relative [&_ol>li]:pl-2
                                        [&_ol>li::marker]:text-purple-600 [&_ol>li::marker]:font-semibold [&_ol>li::marker]:text-sm
